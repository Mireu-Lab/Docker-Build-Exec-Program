...
def build(filename):
    ...
    return {"test build language" : "javascript", "container build time" : round(build_end - build_start, 3), "file execution time" : round(run_end - run_start, 3), "file result" : return_data}